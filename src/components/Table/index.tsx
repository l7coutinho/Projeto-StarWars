...
function Table() {
  ...
  const handleClickButton = () => {
    const newFilter = { column: selectedColumn, comparison: selectedComparison, value: selectedValue };
    const newFilters = [...filters, newFilter];
    setFilters(newFilters);

    const updatedAvailableColumns = availableColumns.filter(column => column !== selectedColumn);
  ...
  const filteredPlanets = filteredPlanetArray.filter((planet: any) =>
